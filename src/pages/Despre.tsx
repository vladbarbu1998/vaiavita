        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 opacity-0 animate-fade-up">
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                {language === "ro" ? (
                  <>
                    <p>
                      La VAIAVITA, credem că excelența nu trebuie să aibă granițe. Ne-am propus să transformăm piața din
                      România prin aducerea unor produse rare, exclusiviste, de la branduri internaționale. Îți oferim
                      acces la formule avansate și soluții inovatoare, disponibile până acum doar pe piețe de elită.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      investiție în tine. Suntem mai mult decât un furnizor – suntem curatorii unui stil de viață trăit
                      cu echilibru, rafinament și standarde înalte.
                    </p>
                  </>
                ) : (
                  <>
                    <p>
                      At VAIAVITA, we believe that excellence should have no boundaries. We set out to transform the
                      Romanian market by bringing rare, exclusive products from international brands. We offer you
                      access to advanced formulas and innovative solutions, previously available only in elite markets.
                    </p>
                    <p>
                      VAIAVITA is your gateway to innovation, quality and refinement. We carefully select each brand and
                      product to bring you not just luxury, but luxury with meaning.
                    </p>
                    <p>
                      Our philosophy is simple: authentic luxury means functionality, usefulness and real impact on your
                      life. Our products combine elegant design with remarkable performance, offering you a premium
                      experience every day.
                    </p>
                    <p>
                      Through VAIAVITA, you enter a clean, select and innovative universe, where every choice becomes an
                      investment in yourself. We are more than a supplier – we are curators of a lifestyle lived with
                      balance, refinement and high standards.
                    </p>
                  </>
                )}
              </div>
            ...
            <div className="opacity-0 animate-fade-up animation-delay-200">
              <img src={despreImage} alt="VAIAVITA Products" className="w-full max-w-md mx-auto rounded-3xl" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="card-premium p-6 md:p-8">
              <div className="flex flex-col md:flex-row gap-6 items-start">
                <div className="w-32 md:w-40 shrink-0 p-4 bg-white rounded-xl">
                  <img src={dentalmedLogo} alt="DentalMed Com Brașov" className="w-full h-auto object-contain" />
                </div>
                <div className="space-y-4">
                  <h3 className="font-display text-xl md:text-2xl tracking-wide">DentalMed Com Brașov</h3>
